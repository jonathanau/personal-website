...
The underlying **source code** for the website (HTML structure, CSS styling, and JavaScript animations) is open-sourced under the [MIT License](LICENSE). You are welcome to fork this repository, use the code as a template, and modify it for your own portfolio. 
